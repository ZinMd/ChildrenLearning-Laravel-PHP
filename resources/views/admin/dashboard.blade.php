    ...
    <div class="container py-5">
        <div class="admin-container">
            ...
            <div class="text-center mb-4">
                <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=2563eb&color=fff" class="avatar mb-2" alt="avatar" style="width:48px;height:48px;">
                <div style="font-size:1.1rem; font-weight:600; color:#2563eb;">{{ Auth::user()->name }}</div>
                <div style="font-size:0.95rem; color:#888;">Connecté</div>
            </div>
            @endauth
